/** Inline SVG icon set — used across sidebar and other components */
...
export const Icons = {
    ...
    Shield: () => (
        <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
            <path d="M10 2L3 5.5V10c0 4 3.25 7.5 7 9 3.75-1.5 7-5 7-9V5.5L10 2z" />
        </svg>
    ),
    Verify: () => (
        <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
    ...
    Logout: () => (
        <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
            ...
            <path d="M7 15v1a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1" />
        </svg>
    ),
    ExternalLink: () => (
        <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
            <path d="M11 3h6v6M17 3L9 11M8 5H4a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1v-4" />
        </svg>
    ),
    Menu: () => (
    ...
    Certificate: () => (
        <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
            ...
            <path d="M12.5 15.5L14 17l1.5-1.5" />
        </svg>
    ),
    DNA: () => (
        <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round">
            <path d="M6 2C6 5.5 14 6.5 14 10C14 13.5 6 14.5 6 18" />
            <path d="M14 2C14 5.5 6 6.5 6 10C6 13.5 14 14.5 14 18" />
    ...
    EyeOff: () => (
        <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
            <path d="M2 2l16 16M7.5 7.5A4.5 4.5 0 0 0 10 10m2.5-1c.2.3.35.65.4 1M1 10s3.5-6 9-6c1.3 0 2.5.3 3.6.8M19 10c-.8 1.5-2.2 3-4 4.2M12 16.4A9 9 0 0 1 10 17c-5.5 0-9-6-9-6l2-2" />
        </svg>
    ),
    Search: () => (
        <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
    ...
    Activity: () => (
        <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
            <polyline points="1 10 5 10 7 4 9 16 11 8 13 12 15 10 19 10" />
        </svg>
    ),
    User: () => (
        <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
